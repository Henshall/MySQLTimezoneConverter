...
class Timezone
{
    ...
    function __construct($servername, $username, $password, $db, $local_timzone = NULL){
        ...
        if ($this->local_timezone == NULL) {
            $this->local_timezone = self::get_local_timezone();
        }
    }
